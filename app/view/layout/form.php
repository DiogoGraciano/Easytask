...
class form extends layout
{
    ...
    public function __construct(string $action,$nome = "manutencao",string $include = "",string $target = "",string $confirmMessage = "",bool $hasRecapcha = false)
    {
        ...
        if($confirmMessage){
            $this->tpl->confirm =' hx-confirm="'.$confirmMessage.'"';
        }
