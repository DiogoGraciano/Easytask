...
class elements extends layout{
    ...
    public function ul(string $value,string $class = "list-group",string $extra = ""):string
    {
        $this->setTemplate("elements.html");
        ...
        $this->tpl->block("BLOCK_UL");  
        
        return $this->parse();
    }

    public function li(string $value,string $class = "list-group-item",string $extra = ""):string
    {
        $this->setTemplate("elements.html");
        ...
        $this->tpl->block("BLOCK_LI");  
        
        return $this->parse();
    }

    public function span(string $value,string $class = "mb-2",string $extra = ""):string
    {
        $this->setTemplate("elements.html");
